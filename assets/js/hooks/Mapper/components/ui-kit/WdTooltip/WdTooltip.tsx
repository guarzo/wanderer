...
export interface TooltipProps {
  /** Tooltip position (defaults to placing near the mouse). */
  position?: TooltipPosition;
  /** Extra spacing from the trigger. */
  offset?: number;
  /** The content to show inside the tooltip. */
  content: (() => React.ReactNode) | React.ReactNode;
  /**
   * If set, the tooltip appears automatically by tracking mouse movement
   * over elements matching this selector.
   */
  targetSelector?: string;
  /** If true, user can mouse onto the tooltip for interactive UIs. */
  interactive?: boolean;
  /** Extra className on the tooltip container. */
  className?: string;
}
