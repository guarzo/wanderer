...
export const SystemSettingsDialog = ({ systemId, visible, setVisible }: SystemSettingsDialog) => {
  ...
  // If you want uppercase input for Ticker
  ...
  const handleSave = useCallback(() => {
    const { name, description, temporary_name, selectedTags, outCommand, systemId, system } = ref.current;
  ...
  // Toggle a code in/out of `selectedTags`.
              ...
              <div className="flex flex-col gap-1">
                ...
                <IconField>
                  ...
                  <InputText
                    ...
                    autoComplete="off"
                    ref={inputRef as any} // for minimal changes
                    value={temporary_name}
                    maxLength={10}
