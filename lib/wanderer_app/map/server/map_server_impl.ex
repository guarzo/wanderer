defmodule WandererApp.Map.Server.Impl do
  ...
  defdelegate untrack_characters(map_id, characters_ids, reason \\ :presence_driven),
    to: CharactersImpl
  ...
  defp update_presence(map_id) do
    case WandererApp.Cache.lookup!("map_#{map_id}:started", false) and
      ...
      true ->
        ...
        CharactersImpl.untrack_characters(map_id, not_present_character_ids, :presence_driven)
