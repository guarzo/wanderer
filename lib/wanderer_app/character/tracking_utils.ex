    ...
    with {:ok, map} <- WandererApp.MapRepo.get(map_id, [:acls]),
      ...
      {:ok, characters_data} =
        build_character_tracking_data(
          ...
          character_settings,
          user_settings_or_nil
        )

      {:ok, main_character} =
        get_main_character(user_settings_or_nil, characters_with_access, characters_with_access)

      following_character_eve_id =
        case user_settings_or_nil do
          nil -> nil
