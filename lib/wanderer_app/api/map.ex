defmodule WandererApp.Api.Map do
  ...
  defp validate_sse_subscription(changeset, _context) do
    ...
    cond do
      ...
      true ->
        validate_active_subscription(map_id, subscriptions_enabled)
    end
  end

  defp validate_active_subscription(map_id, subscriptions_enabled) do
    case WandererApp.Map.is_subscription_active?(map_id, subscriptions_enabled) do
      {:ok, true} ->
        :ok
