defmodule WandererApp.Api.Preparations.FilterMapsByRoles do
  ...
  defp filter_membership(query, actor) do
    ...
    accessible_acl_ids = get_accessible_acl_ids(character_eve_ids, character_corporation_ids, character_alliance_ids)
  ...
  defp get_accessible_acl_ids(character_eve_ids, character_corporation_ids, character_alliance_ids) do
    ...
    query =
      ...
      where: m.eve_character_id in ^character_eve_ids or
