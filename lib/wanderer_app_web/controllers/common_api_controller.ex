defmodule WandererAppWeb.CommonAPIController do
  ...
  Uses cached wormhole type and class data to build detailed information
  about each static wormhole in the system.
  """
  defp get_static_details(statics) do
    Enum.map(statics, fn static_name ->
      ...
      if wh_type do
        create_wormhole_details(wh_type, @wormhole_classes_by_id)
      else
