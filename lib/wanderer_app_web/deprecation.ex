defmodule WandererAppWeb.Deprecation do
  ...
  """
  defmacro deprecated_function(_name, _arity, opts \\ []) do
    message = Keyword.get(opts, :message, "This function is deprecated")
  ...
  def list_deprecated_modules do
    # This would scan all loaded modules
    # For now, return known deprecated modules
    [
      WandererAppWeb.CharactersAPIController,
      WandererAppWeb.MapSystemAPIController,
      WandererAppWeb.MapConnectionAPIController,
      WandererAppWeb.MapAccessListAPIController,
      WandererAppWeb.AccessListMemberAPIController,
      WandererAppWeb.SystemsAPIController,
      WandererAppWeb.MapAuditAPIController
    ]
    |> Enum.map(fn module ->
